    ...
    <table className={pipelineTable}>
      ...
      <tbody>
        ...
        {!isLoading && users.length === 0 && (
          <tr>
            <td colSpan={4 + ADDITIONAL_ENGAGEMENT_COLUMNS.length} className="px-6 py-20 text-center text-text-secondary">
        ...
        {!isLoading && users.map((user) => {
          ...
          return (
            ...
            >
              ...
              <td className={pipelineTd}>
                <span className={`px-3 py-1.5 text-xs font-bold rounded-full border ${user.status === 'For Medical' ? 'bg-primary/10 text-primary-light border-primary/20' :
